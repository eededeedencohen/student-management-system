...
export const COLLECTIONS = {
  ...
  certificateassets: { he: "נכסי תעודות", domain: "certs", desc: "רקעי התעודות, חותמות, לוגואים וקובצי הפונט של המחוללים. חולצו מהמחוללים העצמאיים ויושבים כאן ולא בגיט, כי הריפו ציבורי. הבייטים ב-BinData, המפתח הוא sha של התוכן." },
  certificatesignatures: { he: "חתימות לתעודות", domain: "certs", desc: "חתימה סרוקה או מצוירת, בדרך כלל של מרצה - אחת לתעודה העברית ואחת לתעודה האנגלית." },
  certificatebatches: { he: "קבוצות הפקת תעודות", domain: "certs", desc: "מצב העבודה של מחולל אחד למחזור אחד: הגדרות משותפות (מועד, כיתובי חתימה) ודריסות ידניות פר מקבל/ת. הדריסות לא נוגעות בתלמיד/ה או בעסקה." },
};
