...
console.log(
  `Σ total ₪${Math.round(totalRevenue).toLocaleString()} | Σ collected ₪${Math.round(totalCollected).toLocaleString()} | Σ future ₪${Math.round(totalFuture).toLocaleString()}`,
);
console.log(
  `collected + future = ₪${Math.round(totalCollected + totalFuture).toLocaleString()}  (vs total ₪${Math.round(totalRevenue).toLocaleString()})`,
);
